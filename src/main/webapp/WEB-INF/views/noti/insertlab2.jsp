				...
				<form class="login-form" id="login-form" name="loginform"
					...
					<div class=col-lg-8>
						...
						<div class="form-group">
							<label for="inputlg"> ▣ 담당자 </label> <input
								class="form-control input-lg" id="chrgrNm" name="chrgrNm"
								type="text">
						</div>
						<div class="form-group">
							<label for="inputlg"> ▣ 전화번호 </label> <input
								class="form-control input-lg" id="chrgrTelNo" name="chrgrTelNo"
								type="text">
						</div>
						<div class="form-group">
							<label for="inputlg"> ▣ fax </label> <input
								class="form-control input-lg" id="" name="" type="text">
						</div>
						<div class="form-group">
							<label for="inputlg"> ▣ email </label> <input
								class="form-control input-lg" id="chrgrEmail" name="chrgrEmail"
								type="text">
						</div>

						<div class="form-group">
							<label for="inputlg">▣지역</label> <br> <input type="checkbox"
					...
					<div class="col-lg-4">
						<div class="well">
							...
							<div class="form-group">
								<label for="inputlg"> ▣ 기타 지원 내역 </label> <input
									class="form-control input-lg" id="suprtFvrText"

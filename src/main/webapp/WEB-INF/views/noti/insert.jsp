...
<body>
		...
		<div class="row">
			<div id="notigrad" class="col-lg-12">
				...
				<form class="login-form" id="login-form" name="loginform"
					...
					<input type="hidden" name="tabnm" value="grad" id="type">			
		...
		<div class="row">
			<div id="notilab" class="col-lg-12">
				...
				<form class="login-form" id="login-form" name="loginform"
					method="post"
					action="${pageContext.servletContext.contextPath }/noti/insert">
					<input type="hidden" name="tabnm" value="lab" id="type">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/notijs/notiinsert.js"></script>
</body>
</html>
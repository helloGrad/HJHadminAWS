...
<div class=" w3-col m2 l2">
        <div class=" w3-card-2 w3-white sidebar">
            ...
            <ul class="w3-ul w3-center w3-text-grey" style="letter-spacing: 0.1em;">
                <li><a href="${pageContext.servletContext.contextPath }/noti/grad">대학원 </a></li>
                <li><a href="${pageContext.servletContext.contextPath }/noti/lab">연구실 </a></li>
            </ul>

            <h5 class="w3-center w3-padding-16" style="letter-spacing: 0.3em;"><strong>기관 관리</strong></h5>
            <ul class="w3-ul w3-center w3-text-grey" style="letter-spacing: 0.1em;">
             <li><a href="${pageContext.servletContext.contextPath }/organz/unilist">대학교 </a></li>
